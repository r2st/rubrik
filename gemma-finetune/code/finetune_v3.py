...
def main():
    ...
    # ROUGE-L scoring (needs reference field on each prompt)
    scores = {}
    ...
    print(f"Val loss per epoch: {[round(h['eval_loss'],4) for h in eval_history]}")
    ...
    log = {
        ...
        "rouge_l_per_prompt": scores,
        "val_loss_history": [h["eval_loss"] for h in eval_history],
